python -c "from AlphaBetaPerformanceTests import *; minmax_vs_semi_radom(50, 2, MeasureOneToTwoFactory, 'MinMax_vs_SemiRandom_50_2_Simple.csv', 'MinMax_vs_SemiRandom_50_2_Simple_GameResult.csv')" > /dev/null &
